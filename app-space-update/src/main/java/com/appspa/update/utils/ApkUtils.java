...
public final class ApkUtils {
    ...
    public static void setSupportSilentInstall(boolean supportSilentInstall) {
        ApkUtils.sSupportSilentInstall = supportSilentInstall;
    }
    ...
    public static boolean install(Context context, String filePath) {
        if (ApkUtils.isSystemApplication(context)
    ...
    private static boolean installNormal(Context context, File appFile) {
        try {
            ...
            _AppSpace.onUpdateError(UpdateError.ERROR.INSTALL_FAILED, "Apk installation failed using the intent of the system!");
        }
        return false;
    }
    ...
    public static Intent getInstallAppIntent(File appFile) {
        try {
            ...
            _AppSpace.onUpdateError(UpdateError.ERROR.INSTALL_FAILED, "Failed to get intent for installation！");
        }
        return null;
    }
