...
import com.appspa.update.utils.DialogUtils;
...
public class UpdateDialogFragment extends DialogFragment implements View.OnClickListener, IDownloadEventHandler {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.spa_layout_update_prompter, container);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE_REQUEST_PERMISSIONS) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                _AppSpace.onUpdateError(UpdateError.ERROR.DOWNLOAD_PERMISSION_DENIED);
                dismissDialog();
            }
        }
    ...
    public void show(@NonNull FragmentManager manager, @Nullable String tag) {
        ...
        try {
            ...
            _AppSpace.onUpdateError(UpdateError.ERROR.PROMPT_UNKNOWN, e.getMessage());
        }
    }
    ...
    private void reloadView() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.spa_layout_update_prompter, null);
