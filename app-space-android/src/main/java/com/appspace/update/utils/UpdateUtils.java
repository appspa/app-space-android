...
package com.appspace.update.utils;
...
public final class UpdateUtils {
    ...
    public static void processUpdateEntity(UpdateEntity updateEntity, @NonNull String result, @NonNull IUpdateProxy updateProxy) throws Exception {
        if (updateEntity != null) {
            ...
            _AppSpace.onUpdateError(UpdateError.ERROR.CHECK_PARSE, "json:" + result);
        }
    }
    ...
    public static boolean checkWifi() {
        ConnectivityManager connectivity = (ConnectivityManager) AppSpace.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean startActivity(final Intent intent) {
        ...
        if (AppSpace.getContext().getPackageManager().resolveActivity(intent, PackageManager.MATCH_DEFAULT_ONLY) != null) {
            try {
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                AppSpace.getContext().startActivity(intent);
                return true;
