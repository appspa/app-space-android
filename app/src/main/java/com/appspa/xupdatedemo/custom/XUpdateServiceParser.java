...
import com.appspa.xupdatedemo.entity.ApiResult;
import com.appspa.xupdatedemo.entity.AppVersionInfo;
import com.appspa.xupdatedemo.http.XHttpUpdateHttpService;
import com.appspa.xupdatedemo.utils.SettingSPUtils;
...
public class XUpdateServiceParser extends AbstractUpdateParser {
    ...
    public com.appspa.update.entity.UpdateEntity parseJson(String json) throws Exception {
        ...
        if (apiResult != null) {
            ...
            com.appspa.update.entity.UpdateEntity updateEntity = new UpdateEntity();
