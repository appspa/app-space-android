...
import com.appspa.demo.utils.HProgressDialogUtils;
...
public class CustomUpdatePrompter implements IUpdatePrompter {
     ...
     * @param updateProxy
     */
    private void showUpdatePrompt(final @NonNull com.appspa.update.entity.UpdateEntity updateEntity, final @NonNull com.appspa.update.proxy.IUpdateProxy updateProxy) {
        String updateInfo = com.appspa.update.utils.UpdateUtils.getDisplayUpdateInfo(updateProxy.getContext(), updateEntity);
